...
func TypeFormatMapping() map[jsonschema.SchemaType]map[string]ir.PrimitiveType {
	return map[jsonschema.SchemaType]map[string]ir.PrimitiveType{
		jsonschema.Integer: {
			...
			// See https://github.com/adrianlungu/ogen/issues/307.
			"unix":         ir.Time,
		...
		jsonschema.String: {
			...
			// Custom format, see https://github.com/adrianlungu/ogen/issues/309.
			"int":   ir.Int,
			"int8":  ir.Int8,
			"int16": ir.Int16,
			"int32": ir.Int32,
			...
			"unix-micro":   ir.Time,
			"unix-milli":   ir.Time,
			// See https://github.com/adrianlungu/ogen/issues/957.
			"float32": ir.Float32,
			"float64": ir.Float64,
			"decimal": ir.Decimal,
		},
