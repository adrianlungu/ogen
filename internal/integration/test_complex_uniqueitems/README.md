...
GitHub issue [#1563](https://github.com/adrianlungu/ogen/issues/1563) identified that 11 operations in the JIRA API v3 spec were blocked because they use `uniqueItems` on arrays of complex objects. This implementation removes that limitation.
